...
public class Character : MonoBehaviour
{
    ...
    //protected allows child classes to inherit and change the variables, but they are private to other classes
    ...
    private void Awake()
    {
        ...
        //this determines rate of sphere scale increase
    ...
    //virtual allows child classes to override this parent class method
    ...
    public virtual void FixedUpdate()
    {
        ...
        //if current direction changes, rotate player to new direction
        if(curDir != Vector3.zero)
        {
            //increase size of sphere if current direction not zero
    ...
    //if player is true, execute game over method in GM, else destroy other game object, area outline and drawn areas
    public void Die()
    {
        if (player)
        {
